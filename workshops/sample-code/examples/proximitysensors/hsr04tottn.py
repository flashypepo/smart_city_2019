"""
hsr04tottn.py:
demonstration of getting distance (median)
from proximity sensor HSR04 and
send the measurement to TTN via LoRa.

2020-0324 PP new - NOT TESTED YET - WORK IN PROGRESS
code from:
...
echo = Pin(Pin.exp_board.G7, mode=Pin.IN)  # Lopy4: 'P20'
trigger = Pin(Pin.exp_board.G8, mode=Pin.OUT)  # Lopy4:'P21'
trigger(0)
...
def distance_measure():
    ...
    #  2020-03 PP commented out: return distance
    return -distance  # 2020-0324 PP added sign - reason unknown.
...
def distance_median():
    ...
    # 2020-03 PP commented out: print(distance_samples)
...
# access info
# 2020-03 PP TODO: from lorasettings import app_eui, app_key
