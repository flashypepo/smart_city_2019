'''
neopixelsApp - demo of several animations on a neopixel display
Source:
...
import os
import pycom
from lopy4_board import G22

# disable LED heartbeat (probably not needed in this application)
pycom.heartbeat(False)

# set the number of LEDs
numLed = 37  # 2019-0918 changed, M5stack-hex display
# initialize LEDs
# 2019-0918 ORG: chain = WS2812( ledNumber=numLed, brightness=10, dataPin='P11' ) # dataPin is for LoPy board only
